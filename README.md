Link to webapp: http://i402232.hera.fhict.nl/app/index.html#!/view1
...
app/                    --> all of the source files for the application
  ...
  view1/                --> the view1 view template and logic
    ...
    departments.js              --> the controller logic
    departments_test.js         --> tests of the controller
  view2/                --> the view2 view template and logic
    view2.html            --> the partial template
    employees.js              --> the controller logic
    employees_test.js         --> tests of the controller
